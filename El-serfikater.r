...
sum(na.omit(df4 %>% filter(TypeAnlegg == "Vannkraft") %>% filter(YtelseMW < 10)%>% pull(serfikater)))


library(writexl)

write_xlsx(df4, "//hjemme.uio.no/toroek/UiO/DataScience/Elserfikater/ElSertifikatOversikt")
